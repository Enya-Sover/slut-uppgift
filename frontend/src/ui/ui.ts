...
export const mainContainer = "min-h-screen p-10 bg-gradient-to-b from-blue-100 to-white"
export const mainTitle = "text-5xl font-bold mb-4 text-blue-800"
export const standardDescription = "text-lg mb-8 text-gray-700"
...
export const capitalizeFirstLetter = (str: string) => {
  ...
  export const homeButton = "bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition"